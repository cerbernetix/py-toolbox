...
class TestDuration(unittest.TestCase):
    ...
    @test_cases(
        [
            [0, (0, 0, 0, 0, 0, 0)],
            [123123456789, (0, 2, 3, 123, 456, 789)],
            [123123123123123, (34, 12, 3, 123, 123, 123)],
        ]
    )
    ...
    @test_cases(
        [
            ...
            [0, Duration.PRECISION_MILLISECONDS, "0:00:00:000"],
            [0, Duration.PRECISION_MICROSECONDS, "0:00:00:000:000"],
            [0, Duration.PRECISION_NANOSECONDS, "0:00:00:000:000:000"],
            [123123456789, Duration.PRECISION_HOURS, "0"],
            [123123456789, Duration.PRECISION_MINUTES, "0:02"],
            [123123456789, Duration.PRECISION_SECONDS, "0:02:03"],
            [123123456789, Duration.PRECISION_MILLISECONDS, "0:02:03:123"],
            [123123456789, Duration.PRECISION_MICROSECONDS, "0:02:03:123:456"],
            [123123456789, Duration.PRECISION_NANOSECONDS, "0:02:03:123:456:789"],
            [123123023003023, Duration.PRECISION_HOURS, "34"],
            [123123023003023, Duration.PRECISION_MINUTES, "34:12"],
            [123123023003023, Duration.PRECISION_SECONDS, "34:12:03"],
            [123123023003023, Duration.PRECISION_MILLISECONDS, "34:12:03:023"],
            [123123023003023, Duration.PRECISION_MICROSECONDS, "34:12:03:023:003"],
            [123123023003023, Duration.PRECISION_NANOSECONDS, "34:12:03:023:003:023"],
        ]
    )
